...
import { capitalize, transliterateUrl, urlToCyrillic } from '../../helpers/constants';
...
export const Products = () => {
  ...
  return (
    <>
      ...
      <SEO
        title={`${capitalize(activeCategory)}. ${capitalize(activeFilter)}`}
        description={'Страница категорий'}
        keywords={'Ключевое слово 5, ключевое слово 6'}
      />
    </>
  );
};
